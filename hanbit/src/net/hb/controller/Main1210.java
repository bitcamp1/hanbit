...
import net.hb.model.AnonyInner;
import net.hb.model.AnonyInner2;
import net.hb.model.LocalInner;
import net.hb.model.MemberInner;
import net.hb.model.StaticInner;
